...
describe("POST /graphql/", () => {
  it("GraphQL: Course Query on COMPSCI161(All Fields)", () =>
    request
      .post("/graphql/")
      .send({
        query: `{
      ...
      .then((response) => {
        ...
        expect(
          response.body["data"]["course"]["prerequisite_list"].length > 0
        ).toBeTruthy();
...
describe("POST /graphql/", () => {
  it("GraphQL: Course Query on nonexistent course", () =>
    request
      .post("/graphql/")
      .send({
        query: `query {
...
describe("POST /graphql/", () => {
  it("GraphQL: Syntax Error: Missing quotation mark", () =>
    request
      .post("/graphql/")
      .send({
        query: `query {
  ...
  it("GraphQL: allCourses", () =>
    request
      ...
      .then((response) => {
        ...
        expect(
          response.body["data"]["allCourses"][0]["description"]
        ).not.toBeNull();
...
describe("POST /graphql/", () => {
  it("GraphQL: allCourses Error: Nested course offerings in allCourses", () =>
    request
      .post("/graphql/")
      .send({
        query: `query {
...
describe("POST /graphql/", () => {
  it("GraphQL: Course query with offerings", () =>
    request
      .post("/graphql/")
      .send({
        query: `{
