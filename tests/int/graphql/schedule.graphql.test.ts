...
describe("POST /graphql/", () => {
  it("GraphQL: Schedule Query on COMPSCI Department", () =>
    request
      .post("/graphql/")
      .send({
        query: `{
      ...
      .then((response) => {
        ...
        expect(
          response.body["data"]["schedule"][0]["course"]["department"]
        ).toEqual("COMPSCI");
        ...
        expect(
          response.body["data"]["schedule"][0]["instructors"]
        ).toContainEqual(
          expect.objectContaining({
...
describe("POST /graphql/", () => {
  it("GraphQL: Schedule query on nonexistent course", () =>
    request
      .post("/graphql/")
      .send({
        query: `{
...
describe("POST /graphql/", () => {
  it("GraphQL: Schedule query on instructors with common names", () =>
    request
      .post("/graphql/")
      .send({
        query: `{
...
describe("POST /graphql/", () => {
  it("GraphQL: Schedule query with invalid argument", () =>
    request
      .post("/graphql/")
      .send({
        query: `{
...
describe("POST /graphql/", () => {
  it("GraphQL: Schedule query with invalid quarter argument", () =>
    request
      .post("/graphql/")
      .send({
        query: `{
...
describe("POST /graphql/", () => {
  it("GraphQL: Schedule query without year", () =>
    request
      .post("/graphql/")
      .send({
        query: `{
