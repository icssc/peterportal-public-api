...
describe('GET /courses/all', () => {
    ...
    .then((response) => {
        ...
        expect(response.body['I&CSCI46']['id'], 'I&C SCI 46');
    }));
});
...
describe('GET /courses/I&CSCI33', () => {
    ...
    .expect(200)
    .then((response) => {
        expect(response.body['id'], 'I&C SCI 33');
        expect(response.body['name'], 'Intermediate Programming');
        expect(typeof response.body['dependencies'], 'array');
    }));
});