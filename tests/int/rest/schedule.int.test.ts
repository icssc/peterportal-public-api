...
describe("GET /schedule/soc", () => {
  it("sends valid query string to /schedule/soc", () =>
    request
      .get(
        "/rest/v0/schedule/soc?instructorName=Carvalho&term=2021+Winter&ge=ANY&department=ECON&courseNumber=100B&division=ALL&sectionCodes=62120&courseTitle=INTER+ECONOMICS+II&sectionType=ALL&units=4&days=TuTh&startTime=11:00AM&endTime=12:20PM&maxCapacity=344&fullCourses=ANY&cancelledCourses=EXCLUDE"
      )
...
describe("GET /schedule/soc", () => {
  it("sends invalid query string to /schedule/soc", () =>
    request
