...
describe("GET /instructors/all", () => {
  it("returns a json of all instructors", () =>
    request
...
describe("GET /instructors/mikes", () => {
  it("returns a json of a specific instructor", () =>
    request
...
describe("GET /instructors/randomguy", () => {
  it("returns an error for instructor that does not exist", () =>
    request
  ...
  it("returns an error message for a course that does not exist", () =>
    request
      ...
      .then((response) => {
        ...
        expect(result["pattis"]).toMatchObject({
          name: "Richard Eric Pattis",
          ucinetid: "pattis",
        });
        expect(result["mikes"]).toMatchObject({
          name: "Michael Shindler",
          ucinetid: "mikes",
        });
