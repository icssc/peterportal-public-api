$(document).ready(function() {
    ...
    $('#register_form').validate({
        submitHandler: function(form, event) {
            ...
            // process the form
            alert("An email containing the next steps has been sent to the address. " + 
            "Please check your inbox to activate your key. " +
            "Your key will not work until it has been activated.")
            // $.ajax({
            ...
            //         alert(`An email containing the next steps has been sent to the address. Please check your inbox to activate your key.
            //         Your key will not work until it has been activated`)
