    ...
    describe('Fetching specific courses', () => {
        it ('getSpecificCourse should return a json of the course requested', () => {
            ...
            expect(course).toMatchObject({
                ...
                "terms": ["2020 Winter","2020 Fall", "2019 Fall","2019 Winter","2019 Spring","2018 Fall","2018 Winter","2018 Spring","2018 Summer1","2018 Summer10wk","2017 Fall","2017 Winter","2017 Spring"]
            });
        });
    });
});